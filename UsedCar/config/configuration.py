...
from UsedCar.entity.config_entity import DataIngestionConfig, DataValidationConfig, \
                                         DataTransformationConfig, ModelTrainingConfig, ModelEvaluationConfig, ModelPusherConfig, TrainingPipelineConfig
from UsedCar.utils.utils import read_yaml_file
import os
import sys
import logging
from UsedCar.constant import *
from UsedCar.exception.exception import UsedCarCustomException
...
class Configuartion:
    ...
    def __init__(self,config_file_path:str =CONFIG_FILE_PATH, current_time_stamp:str = CURRENT_TIME_STAMP) -> None:
        try:
            ...
            message = UsedCarCustomException(e, sys)
